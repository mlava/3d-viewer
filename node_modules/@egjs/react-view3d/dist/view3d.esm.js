...
import VanillaView3D__default, { DEFAULT_CLASS, EVENTS, withMethods } from '@egjs/view3d';
export * from '@egjs/view3d';
...
var view3DSetterNames = Object.getOwnPropertyNames(VanillaView3D__default.prototype).filter(function (name) {
  var descriptor = Object.getOwnPropertyDescriptor(VanillaView3D__default.prototype, name);
...
function (_super) {
  ...
  function View3D(props) {
    ...
    withMethods(_this, "_vanillaView3D");
    return _this;
  }
  ...
  __proto.componentDidMount = function () {
    this._vanillaView3D = new VanillaView3D__default(this._containerEl, this.props);
  ...
  __proto.render = function () {
    ...
    var Container = tag;
    var wrapperClassName = "".concat(DEFAULT_CLASS.WRAPPER, " ").concat(className).trim();
    var canvasClassName = "".concat(DEFAULT_CLASS.CANVAS, " ").concat(canvasClass).trim();
    var attributes = {};

    for (var name in restProps) {
      if (!name.startsWith("on") && !(name in VanillaView3D__default.prototype)) {
